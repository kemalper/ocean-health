...
.btn-nav:hover{background:#085041;color:#fff!important}
        ...
        .hero-stat-n{font-family:'DM Serif Display',serif;font-size:28px;color:#90f9d2;font-weight:400;line-height:1}
        ...
        .proc-card:hover{transform:translateY(-3px);box-shadow:0 10px 30px rgba(0,0,0,.08);border-color:#bbfbe4}
        .proc-card.featured{border-color:#085041;background:#e3fdf3}
        ...
        .proc-saving{font-size:11px;background:#e3fdf3;color:#08533f;border-radius:20px;padding:3px 10px;font-weight:600}
        ...
        .btn-cta-w{background:#90f9d2;color:#0a2e22;border:none;padding:14px 28px;border-radius:10px;font-size:15px;font-weight:600;display:inline-flex;align-items:center;gap:8px;cursor:pointer;font-family:'Inter',sans-serif;transition:all .2s}
        .btn-cta-w:hover{background:#bbfbe4}
