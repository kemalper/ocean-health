...
.btn-nav:hover{background:#085041;color:#fff!important}
        ...
        .kicker{font-size:12px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#aef1d8;margin-bottom:1rem}
        ...
        .hero-stat-n{font-family:'DM Serif Display',serif;font-size:28px;color:#aef1d8;font-weight:400;line-height:1}
        ...
        .proc-card:hover{transform:translateY(-3px);box-shadow:0 10px 30px rgba(0,0,0,.08);border-color:#bafde4}
        .proc-card.featured{border-color:#0d6b55;background:#f0fffa}
        ...
        .proc-price{font-size:14px;font-weight:600;color:#0d6b55}
        .proc-uk{font-size:11px;color:#aaa;margin-top:2px}
        .proc-saving{font-size:11px;background:#dbfef1;color:#0d3e2c;border-radius:20px;padding:3px 10px;font-weight:600}
        .proc-link{font-size:12px;color:#0d6b55;font-weight:600;margin-top:.75rem;display:inline-flex;align-items:center;gap:4px}
        ...
        .cta-box{background:linear-gradient(135deg,#0d3e2c,#1d9e75);border-radius:20px;padding:3rem;text-align:center}
        ...
        .btn-cta-w{background:#fff;color:#0d3e2c;border:none;padding:14px 28px;border-radius:10px;font-size:15px;font-weight:600;display:inline-flex;align-items:center;gap:8px;cursor:pointer;font-family:'Inter',sans-serif;transition:all .2s}
        .btn-cta-w:hover{background:#dbfef1}
      ...
      <footer>
        <div className="inner">
          <div className="footer-legal">
            ...
            Flights not included · Client payments held in a designated client account · Coordinator, not a dental provider · Elective procedures only<br />
